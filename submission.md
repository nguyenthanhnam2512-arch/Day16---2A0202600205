...
*Phiên bản: **Version B (BTVN, GitHub)** — 23/04/2026. Version A cần nộp tách trên LMS (bản chụp suy nghĩ sáng) — **không chỉnh A sau khi nộp**; file này thể hiện bước cải thiện theo góp ý/ stress-test và rubric so sánh A→B.*
